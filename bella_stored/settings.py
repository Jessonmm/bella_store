"""
Django settings for bella_stored project.
...
ROOT_URLCONF = 'bella_stored.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'category.context_processors.categories_link',  # Add this line
                'category.context_processors.subcategories_link',  # Add this line
                'category.context_processors.variation_link',
            ],
        },
    },
]
...
WSGI_APPLICATION = 'bella_stored.wsgi.application'
